...
resource "aws_internet_gateway" "edsys_vpc_igw" {
  vpc_id = aws_vpc.edsys_vpc.id
...
resource "aws_nat_gateway" "edsys_nat_gwy" {
  ...
  depends_on    = [aws_internet_gateway.edsys_vpc_igw, aws_eip.nat_eip]
}
...
resource "aws_route_table" "public_rt" {
  ...
  route {
    ...
    gateway_id = aws_internet_gateway.edsys_vpc_igw.id
  }
}
